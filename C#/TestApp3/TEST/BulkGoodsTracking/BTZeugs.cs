...
namespace TactileGraphDemo
{
    class BTZeugs
    {
        ...
        /// </summary>
        public class BLEAttributeDisplayContainer
        {
            ...
            public BLEAttributeDisplayContainer(GattDeviceService service)
            {
            ...
            public BLEAttributeDisplayContainer(GattCharacteristic characteristic)
            {
            ...
            public GattNativeCharacteristicUuid characteristicName;
            public GattNativeServiceUuid serviceName;
            ...
            private void Init()
            {
                switch (AttributeDisplayType)
                {
                    case AttributeType.Service:
                        ...
                        {
                            Name = "Custom Service: " + service.Uuid;
                            return;
                        }
                        break;
                    case AttributeType.Characteristic:
                        if (IsSigDefinedUuid(characteristic.Uuid))
                        {
                            ...
                            {
                                Name = characteristicName.ToString();
                                return;
                            }
                        }
                        else
                        {
                            Name = "Custom Characteristic: " + characteristic.Uuid;
                            return;
                        }
                        break;
                    default:
